...
class Table {
  public:
    ...
    void append(const itch_totalview::direct_listing_with_capital_raise_price_discovery_message& message) {
        ...
        column_2_.append(message.fields.timestamp.get().value());
        column_4_.append(message.fields.stock.get_trimmed().value());
        column_62_.append(itch_totalview::open_eligibility_status::to_string(message.fields.open_eligibility_status.get().value()));
        column_63_.append(message.fields.minimum_allowable_price.get().value());
        column_64_.append(message.fields.maximum_allowable_price.get().value());
        column_65_.append(message.fields.near_execution_price.get().value());
        column_66_.append(message.fields.near_execution_time.get().value());
        column_67_.append(message.fields.lower_price_range_collar.get().value());
        column_68_.append(message.fields.upper_price_range_collar.get().value());
        column_3_.null();
        column_5_.null();
        column_6_.null();
        column_7_.null();
  ...
  private:
    ...
    omi::parquet::wide::Text column_62_{  };   // open_eligibility_status
    omi::parquet::wide::Decimal column_63_{ arrow::decimal128(10, 4) };   // minimum_allowable_price
    omi::parquet::wide::Decimal column_64_{ arrow::decimal128(10, 4) };   // maximum_allowable_price
    omi::parquet::wide::Decimal column_65_{ arrow::decimal128(10, 4) };   // near_execution_price
    omi::parquet::wide::Unsigned column_66_{  };   // near_execution_time
    omi::parquet::wide::Decimal column_67_{ arrow::decimal128(10, 4) };   // lower_price_range_collar
    omi::parquet::wide::Decimal column_68_{ arrow::decimal128(10, 4) };   // upper_price_range_collar
};
