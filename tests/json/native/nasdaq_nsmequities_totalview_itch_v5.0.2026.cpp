// Nasdaq.NsmEquities.TotalView.Itch.v5.0.2026 native json tests over the packet corpus.
//
...
#include "json/native/nasdaq/nsmequities/totalview/itch/v5.0.2026/Json.hpp"
...
int main() {
    std::printf("== Nasdaq.NsmEquities.TotalView.Itch.v5.0.2026 (native json)\n");
