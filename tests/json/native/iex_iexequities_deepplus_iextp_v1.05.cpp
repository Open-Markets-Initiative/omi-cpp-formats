// Iex.IexEquities.DeepPlus.IexTp.v1.05 native json tests over the packet corpus.
//
...
#include "json/native/iex/iexequities/deepplus/iextp/v1.05/Json.hpp"
...
int main() {
    std::printf("== Iex.IexEquities.DeepPlus.IexTp.v1.05 (native json)\n");
