// Nasdaq.NsmEquities.TotalView.Itch.v5.0.2018 native json tests over the packet corpus.
//
...
int main() {
    std::printf("== Nasdaq.NsmEquities.TotalView.Itch.v5.0.2018 (native json)\n");
