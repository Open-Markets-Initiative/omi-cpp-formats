// Iex.IexEquities.DeepPlus.IexTp.v1.04 rapid json tests over the packet corpus.
//
...
#include "json/rapid/iex/iexequities/deepplus/iextp/v1.04/Json.hpp"
...
int main() {
    std::printf("== Iex.IexEquities.DeepPlus.IexTp.v1.04 (rapid json)\n");
