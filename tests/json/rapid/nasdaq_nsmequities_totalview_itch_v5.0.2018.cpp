// Nasdaq.NsmEquities.TotalView.Itch.v5.0.2018 rapid json tests over the packet corpus.
//
...
#include "json/rapid/nasdaq/nsmequities/totalview/itch/v5.0.2018/Json.hpp"
...
int main() {
    std::printf("== Nasdaq.NsmEquities.TotalView.Itch.v5.0.2018 (rapid json)\n");
