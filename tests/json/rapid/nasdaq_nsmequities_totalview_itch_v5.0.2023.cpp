// Nasdaq.NsmEquities.TotalView.Itch.v5.0.2023 rapid json tests over the packet corpus.
//
...
#include "json/rapid/nasdaq/nsmequities/totalview/itch/v5.0.2023/Json.hpp"
...
int main() {
    std::printf("== Nasdaq.NsmEquities.TotalView.Itch.v5.0.2023 (rapid json)\n");
