...
struct ipo_quoting_period_update_message {
    ...
    struct fields_type {
        ...
        itch_aggregated::ipo_quotation_release_time ipo_quotation_release_time;
        itch_aggregated::ipo_quotation_release_qualifier ipo_quotation_release_qualifier;
        itch_aggregated::ipo_price ipo_price;
    };
