...
// consolidated_high_price
struct consolidated_high_price {

    static constexpr const char* name = "consolidated_high_price";
    ...
    constexpr consolidated_high_price()
     : value{ 0 } {}

    consolidated_high_price(std::uint64_t v)
