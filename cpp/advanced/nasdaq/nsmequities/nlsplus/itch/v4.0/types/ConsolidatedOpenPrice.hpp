...
// consolidated_open_price
struct consolidated_open_price {

    static constexpr const char* name = "consolidated_open_price";
    ...
    constexpr consolidated_open_price()
     : value{ 0 } {}

    consolidated_open_price(std::uint64_t v)
