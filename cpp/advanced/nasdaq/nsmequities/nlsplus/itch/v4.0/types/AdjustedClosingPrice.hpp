...
struct adjusted_closing_price {

    static constexpr const char* name = "adjusted_closing_price";
    ...
    constexpr adjusted_closing_price()
     : value{ 0 } {}

    adjusted_closing_price(std::uint64_t v)
