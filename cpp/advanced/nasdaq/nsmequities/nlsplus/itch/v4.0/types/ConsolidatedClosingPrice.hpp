...
// consolidated_closing_price
struct consolidated_closing_price {

    static constexpr const char* name = "consolidated_closing_price";
    ...
    constexpr consolidated_closing_price()
     : value{ 0 } {}

    consolidated_closing_price(std::uint64_t v)
