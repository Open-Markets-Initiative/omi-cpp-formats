...
// corrected_trade_control_number
struct corrected_trade_control_number {

    static constexpr const char* name = "corrected_trade_control_number";
    ...
    constexpr corrected_trade_control_number() {
