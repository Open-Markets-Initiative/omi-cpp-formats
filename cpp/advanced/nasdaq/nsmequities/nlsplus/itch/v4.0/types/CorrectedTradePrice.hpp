...
// corrected_trade_price
struct corrected_trade_price {

    static constexpr const char* name = "corrected_trade_price";
    ...
    constexpr corrected_trade_price()
     : value{ 0 } {}

    corrected_trade_price(std::uint64_t v)
