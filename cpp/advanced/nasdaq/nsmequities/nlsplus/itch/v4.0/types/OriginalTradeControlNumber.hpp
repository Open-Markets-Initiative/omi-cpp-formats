...
// original_trade_control_number
struct original_trade_control_number {

    static constexpr const char* name = "original_trade_control_number";
    ...
    constexpr original_trade_control_number() {
