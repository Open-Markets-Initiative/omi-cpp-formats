...
struct issue_classification {
    ...
    static constexpr std::array<std::pair<std::string_view, enum_type>, 16> from_string_map = {{
        ...
        {"Unit", enum_type::unit},
        {"Units Bi", enum_type::units_bi},
        {"Warrant", enum_type::warrant}
    }};

    static constexpr std::string_view to_string(enum_type value) {
        switch (value) {
            case enum_type::ads: return "Ads";
            ...
            case enum_type::ordinary: return "Ordinary";
            ...
            case enum_type::units_bi: return "Units Bi";
