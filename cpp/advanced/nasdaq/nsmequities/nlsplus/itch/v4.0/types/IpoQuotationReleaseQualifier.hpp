...
struct ipo_quotation_release_qualifier {
    ...
    enum class enum_type : char {
        anticipated = 'A',
        canceled_postponed = 'C'
    };

    static constexpr std::array<std::pair<std::string_view, enum_type>, 2> from_string_map = {{
        {"Anticipated", enum_type::anticipated},
        {"Canceled Postponed", enum_type::canceled_postponed}
    }};

    static constexpr std::string_view to_string(enum_type value) {
        switch (value) {
            case enum_type::anticipated: return "Anticipated";
            case enum_type::canceled_postponed: return "Canceled Postponed";
    ...
    constexpr void set(result_type value) {
        if (value.has_value())
            ...
            set(enum_type::canceled_postponed);
    }
