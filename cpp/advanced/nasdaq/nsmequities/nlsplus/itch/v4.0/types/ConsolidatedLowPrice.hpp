...
// consolidated_low_price
struct consolidated_low_price {

    static constexpr const char* name = "consolidated_low_price";
    ...
    constexpr consolidated_low_price()
     : value{ 0 } {}

    consolidated_low_price(std::uint64_t v)
