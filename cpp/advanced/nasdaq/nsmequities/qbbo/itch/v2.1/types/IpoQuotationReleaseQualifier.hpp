...
struct ipo_quotation_release_qualifier {
    ...
    enum class enum_type : char {
        ...
        ipo_release_canceled_postponed = 'C'
    };
    ...
    static constexpr std::array<std::pair<std::string_view, enum_type>, 2> from_string_map = {{
        ...
        {"Ipo Release Canceled Postponed", enum_type::ipo_release_canceled_postponed}
    }};

    static constexpr std::string_view to_string(enum_type value) {
        switch (value) {
            case enum_type::anticipated_quotation_release_time: return "Anticipated Quotation Release Time";
            case enum_type::ipo_release_canceled_postponed: return "Ipo Release Canceled Postponed";
    ...
    constexpr void set(result_type value) {
        if (value.has_value())
            ...
            set(enum_type::ipo_release_canceled_postponed);
    }
