...
struct financial_status_indicator {
    ...
    static constexpr std::array<std::pair<std::string_view, enum_type>, 11> from_string_map = {{
        ...
        {"Creations Andor Redemptions Suspended", enum_type::creations_andor_redemptions_suspended},
    ...
    static constexpr std::string_view to_string(enum_type value) {
        switch (value) {
            ...
            case enum_type::creations_andor_redemptions_suspended: return "Creations Andor Redemptions Suspended";
