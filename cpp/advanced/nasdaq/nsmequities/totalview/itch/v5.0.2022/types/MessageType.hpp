...
namespace nasdaq::nsmequities::totalview::itch::v5_0_2022 {
...
struct message_type {
    ...
    static constexpr std::array<std::pair<std::string_view, enum_type>, 22> from_string_map = {{
    ...
    constexpr void set(result_type value) {
        if (value.has_value())
            ...
            set(enum_type::retail_price_improvement_indicator_message);
    }
