...
struct reg_sho_action {
    ...
    constexpr void set(result_type value) {
        if (value.has_value())
            ...
            set(enum_type::reg_sho_short_sale_price_test);
    }
