...
struct message_type {
    ...
    static constexpr std::array<std::pair<std::string_view, enum_type>, 21> from_string_map = {{
        ...
        {"Retail Interest Message", enum_type::retail_interest_message},
    ...
    static constexpr std::string_view to_string(enum_type value) {
        switch (value) {
            ...
            case enum_type::retail_interest_message: return "Retail Interest Message";
    ...
    constexpr void set(result_type value) {
        if (value.has_value())
            ...
            set(enum_type::retail_interest_message);
    }
