...
struct financial_status_indicator {
    ...
    enum class enum_type : char {
        ...
        creations_andor_redemptions_suspended_for_exchange_traded_product = 'C',
        normal = 'N',
        in_compliance = ' '
    };
    ...
    static constexpr std::array<std::pair<std::string_view, enum_type>, 11> from_string_map = {{
        ...
        {"Creations Andor Redemptions Suspended For Exchange Traded Product", enum_type::creations_andor_redemptions_suspended_for_exchange_traded_product},
    ...
    static constexpr std::string_view to_string(enum_type value) {
        switch (value) {
            ...
            case enum_type::creations_andor_redemptions_suspended_for_exchange_traded_product: return "Creations Andor Redemptions Suspended For Exchange Traded Product";
