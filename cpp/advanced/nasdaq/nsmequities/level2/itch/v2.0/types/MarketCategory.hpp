...
struct market_category {
    ...
    static constexpr std::array<std::pair<std::string_view, enum_type>, 10> from_string_map = {{
        {"Bats Bzx Exchange", enum_type::bats_bzx_exchange},
        ...
        {"New York Stock Exchange", enum_type::new_york_stock_exchange},
    ...
    static constexpr std::string_view to_string(enum_type value) {
        switch (value) {
            ...
            case enum_type::new_york_stock_exchange: return "New York Stock Exchange";
            ...
            case enum_type::bats_bzx_exchange: return "Bats Bzx Exchange";
