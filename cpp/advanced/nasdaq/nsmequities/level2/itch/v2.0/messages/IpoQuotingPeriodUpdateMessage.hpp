...
struct ipo_quoting_period_update_message {
    ...
    struct fields_type {
        ...
        itch_level2::ipo_quotation_release_time ipo_quotation_release_time;
        itch_level2::ipo_quotation_release_qualifier ipo_quotation_release_qualifier;
        itch_level2::ipo_price ipo_price;
    };
