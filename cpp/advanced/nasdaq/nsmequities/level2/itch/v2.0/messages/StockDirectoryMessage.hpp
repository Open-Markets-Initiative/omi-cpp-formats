...
struct stock_directory_message {
    ...
    struct fields_type {
        ...
        itch_level2::market_category market_category;
        itch_level2::financial_status_indicator financial_status_indicator;
        itch_level2::round_lot_size round_lot_size;
        itch_level2::round_lots_only round_lots_only;
        itch_level2::issue_classification issue_classification;
        itch_level2::issue_subtype issue_subtype;
        itch_level2::authenticity authenticity;
        itch_level2::short_sale_threshold_indicator short_sale_threshold_indicator;
        itch_level2::ipo_flag ipo_flag;
        itch_level2::luld_reference_price_tier luld_reference_price_tier;
        itch_level2::etp_flag etp_flag;
        itch_level2::etp_leverage_factor etp_leverage_factor;
        itch_level2::inverse_indicator inverse_indicator;
    };
