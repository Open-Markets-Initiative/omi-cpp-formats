...
struct direct_listing_with_capital_raise_price_discovery_message {
    ...
    struct fields_type {
        ...
        itch_noiview::open_eligibility_status open_eligibility_status;
        itch_noiview::minimum_allowable_price minimum_allowable_price;
        itch_noiview::maximum_allowable_price maximum_allowable_price;
        itch_noiview::near_execution_price near_execution_price;
        itch_noiview::near_execution_time near_execution_time;
        itch_noiview::lower_price_range_collar lower_price_range_collar;
        itch_noiview::upper_price_range_collar upper_price_range_collar;
    };
