...
struct imbalance_direction {
    ...
    static constexpr std::string_view to_string(enum_type value) {
        switch (value) {
            ...
            case enum_type::insufficient_orders_to_calculate: return "Insufficient Orders To Calculate";
