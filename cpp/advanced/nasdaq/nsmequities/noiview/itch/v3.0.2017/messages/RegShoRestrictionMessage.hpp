...
struct reg_sho_restriction_message {
    ...
    struct fields_type {
        ...
        itch_noiview::reg_sho_action reg_sho_action;
    };
...
static_assert(offsetof(reg_sho_restriction_message::fields_type, timestamp) == 2, "unexpected offset of reg_sho_restriction_message::fields_type::timestamp");
