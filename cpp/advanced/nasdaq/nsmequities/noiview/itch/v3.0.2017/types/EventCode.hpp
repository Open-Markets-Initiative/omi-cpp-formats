...
struct event_code {
    ...
    enum class enum_type : char {
        ...
        clear_noii_opening_cross_data = 'X',
    ...
    static constexpr std::array<std::pair<std::string_view, enum_type>, 7> from_string_map = {{
        {"Clear Noii Opening Cross Data", enum_type::clear_noii_opening_cross_data},
    ...
    static constexpr std::string_view to_string(enum_type value) {
        switch (value) {
            ...
            case enum_type::clear_noii_opening_cross_data: return "Clear Noii Opening Cross Data";
